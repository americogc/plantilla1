        ...
        <div>
            <Container maxWidth="sm">
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs>
                            <Button fullWidth color="secondary" variant="contained">Nuevo</Button>                                                       
                    </Grid>
                    <Grid item xs>
                            <Button fullWidth color="secondary" variant="contained">Guardar</Button>                                                       
                    </Grid>
                    <Grid item xs>
                            <Button fullWidth color="secondary" variant="contained">Actualizar</Button>                                                       
                    </Grid>
                    <Grid item xs>
                            <Button fullWidth color="secondary" variant="contained">Eliminar</Button>                                                       
                    </Grid>
